...
subtitle: "Pilot for St Lucia campus Aug 2016"
...
saveRDS(green_bridge, "data/counters/clean/green_bridge.Rds")
```
...
saveRDS(macquarie_bikes, "data/counters/clean/macquarie_bikes.Rds")
```
...
saveRDS(vehicles, "data/counters/clean/vehicles.Rds")
```
...
saveRDS(occupancy_week, "data/counters/clean/occupancy_week.Rds")
...
saveRDS(occupancy_weekend, "data/counters/clean/occupancy_weekend.Rds")
...
saveRDS(vehicles_occupancy, "data/counters/clean/vehicles_occupancy.Rds")
...
# write_csv(uq_campus_long, "data/counters/clean/uq_campus_long.csv")
...
# write_csv(uq_campus_wide, "data/counters/clean/uq_campus_wide.csv")
